...
const Contact = () => {
    ...
    return(      
        ...
        <div className="py-6 px-6 lg:pl-44 bg-green-950 text-white flex flex-col lg:pb-8 pb-16">
            <span className="text-xl lg:text-2xl font-semibold lg:p-2 lg:mt-2">Contacto</span>
